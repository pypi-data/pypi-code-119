...
#Constant value of input data limitations for pre-assessment of customer cluster setup
UPPER_BOUND_TARGET_NUM_FOR_SMALL_TSHIRT_SIZE = 5
UPPER_BOUND_TARGET_NUM_FOR_MEDIUM_TSHIRT_SIZE = 10
UPPER_BOUND_TARGET_NUM_FOR_LARGE_TSHIRT_SIZE = 20
...
def make_holdout_split(
    ...
    _validate_target_nums(tshirt_size,target_columns)
...
def _validate_target_nums(tshirt_size, target_columns):
    # Add input data Limitation for pre-assessment of customer cluster setup.
    if tshirt_size == "M" and len(target_columns) > UPPER_BOUND_TARGET_NUM_FOR_MEDIUM_TSHIRT_SIZE:
        raise Exception(Messages.get_message(str(UPPER_BOUND_TARGET_NUM_FOR_MEDIUM_TSHIRT_SIZE),message_id='AUTOAITSLIBS0083E'))

    if tshirt_size == "S" and len(target_columns) > UPPER_BOUND_TARGET_NUM_FOR_SMALL_TSHIRT_SIZE:
        raise Exception(Messages.get_message(str(UPPER_BOUND_TARGET_NUM_FOR_SMALL_TSHIRT_SIZE),message_id='AUTOAITSLIBS0083E'))

    if tshirt_size == "L" and len(target_columns) > UPPER_BOUND_TARGET_NUM_FOR_LARGE_TSHIRT_SIZE:
        raise Exception(Messages.get_message(str(UPPER_BOUND_TARGET_NUM_FOR_LARGE_TSHIRT_SIZE),message_id='AUTOAITSLIBS0083E'))
