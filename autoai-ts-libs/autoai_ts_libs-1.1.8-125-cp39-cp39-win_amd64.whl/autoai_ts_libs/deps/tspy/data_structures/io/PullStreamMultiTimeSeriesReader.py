...
class PullStreamMultiTimeSeriesReader(object):
    """
    ...
    def __init__(self):
        ...
        self._j_reader = self._tsc._jvm.com.ibm.research.time_series.streaming.io.PythonPullStreamMultiTimeSeriesReader(
