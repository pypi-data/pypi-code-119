...
class MultiTimeSeriesWriter:
    ...
    def encode_value(self, value_encoder):
        ...
        """
        self._j_time_series_writer.encodeValue(utils.UnaryMapFunction(self._tsc, value_encoder))
        return self
    ...
    def encode_key(self, key_encoder):
        ...
        """
        self._j_time_series_writer.encodeKey(utils.UnaryMapFunction(self._tsc, key_encoder))
        return self
    ...
    def save(self, multi_time_series_write_format):
        ...
        """
        self._j_time_series_writer.save(utils.JavaMultiTimeSeriesWriteFormat(self._tsc, multi_time_series_write_format))
