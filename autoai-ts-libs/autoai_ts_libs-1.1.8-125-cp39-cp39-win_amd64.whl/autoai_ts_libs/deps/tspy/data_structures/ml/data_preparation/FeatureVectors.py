...
def prepare_predictions(data_time_series, left_delta, right_delta, label_range, feature_range=None,
    ...
    j_str = tsc._jvm.com.ibm.research.time_series.ml.data_curation.FeatureVectors.preparePythonToString(
        ...
        feature_range[0],
        feature_range[1],
        -1.0, # this will signify the special method that is meant for predictions
        -1.0, # this will signify the special method that is meant for predictions
        False
    )
...
def prepare(data_time_series, label_time_series, anchor, left_delta, right_delta, pos_perc=1.0, neg_perc=.05,
            label_range=None, feature_range=None, with_replacement=False, flatten_vector=False):
    """
